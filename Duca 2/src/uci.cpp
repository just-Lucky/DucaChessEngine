...
// Helper taht converts interal 16-bit move into UCI format
...
// Helper that parses a UCI string and finds the corresponding move
...
void parse_go(Board& board, std::stringstream& ss) {
    std::string token;
    int depth = 16; // Engine's Max Depth
